      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <AnimatedSection animation="fade-left" delay={100}>
            <div className="bg-background rounded-2xl p-6 md:p-8 border border-border hover:border-primary/50 transition-all duration-300 card-hover h-full">
              <div className="mb-6">
          ...
          <AnimatedSection animation="fade-right" delay={200}>
            <div className="relative bg-background rounded-2xl p-6 md:p-8 border-2 border-primary shadow-lg h-full">
              {/* Popular Badge */}
        ...
        {!showFullDetails && (
          <AnimatedSection animation="fade-up" delay={500} className="text-center mt-8">
            <Link to="/pricing">
