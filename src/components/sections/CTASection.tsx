    ...
    <section className={`section-padding ${bgClass}`}>
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className={`font-heading text-3xl md:text-4xl font-bold ${textClass} mb-4`}>
            {title}
          </h2>
          <p className={`${textClass}/80 text-lg mb-8`}>
            {subtitle}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Button 
                size="lg" 
                className={`w-full sm:w-auto gap-2 ${variant === "accent" ? "bg-accent hover:bg-accent/90" : "bg-accent hover:bg-accent/90"} text-accent-foreground`}
              >
            ...
            <a href={`tel:${BUSINESS_INFO.phone}`}>
              <Button 
                size="lg" 
                variant="outline" 
                className={`w-full sm:w-auto gap-2 border-background/30 ${textClass} hover:bg-background/10`}
              >
          ...
          <p className={`${textClass}/60 text-sm mt-6`}>
